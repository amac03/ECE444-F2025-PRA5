...
<html lang="en">
    ...
    <form action="/predict-form" method="post">
        <label for="message">Enter text to classify:</label><br>
        <input type="text" id="message" name="message">
        <input type="submit" value="Predict">
    </form>
    <p>Prediction: <span id="paramValue" class="param">{% if prediction == null %} No prediction! {% else %} {{prediction}} {% endif %}</span></p>
